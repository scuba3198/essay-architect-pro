...
import { Essay, TourProps } from '../types';
...
const PreviewSection: React.FC<PreviewSectionProps> = ({ essay, totalWordCount, setShowExaminer, copyToClipboard, tourProps, isPaid, examinerUsageCount }) => {
