        ...
        return (
            <div className="flex gap-2">
                <button
                    ...
                    title={isPaid ? "Autocomplete sentence" : canUseFree ? `${freeLeft} Free AI Uses Left (10 Total)` : "Unlock for AI Autocomplete"}
                >
                    {generatingField === `${section}-${field}` ? <Wand2 size={10} className="animate-spin" /> : (!isPaid && !canUseFree) ? <Lock size={10} /> : <Zap size={10} />}
                    {isPaid ? 'Complete' : canUseFree ? `${freeLeft} Free AI Uses Left` : 'Unlock Pro'}
                </button>
                <button
                    ...
                    title={isPaid ? "Polished by AI" : canUseFree ? `${freeLeft} Free AI Uses Left (10 Total)` : "Unlock for AI Refinement"}
                >
