...
Essay:
      ...
      const resultText = await callProAI(
        prompt,
    ...
    <div className="fixed inset-0 bg-stone-900/90 z-[100] flex items-center justify-center p-4 animate-in fade-in duration-300">
      <div className="bg-[#f4f1ea] border-2 border-stone-900 shadow-[8px_8px_0px_0px_rgba(255,255,255,1)] max-w-2xl w-full max-h-[90vh] overflow-y-auto relative custom-scrollbar">
        ...
        <div className="p-8 pt-0 space-y-6">
          {!examType ? (
            <div className="text-center py-8">
              ...
              <p className="text-stone-500 mb-8 text-sm">
                Choose the exam criteria you wish to be scored against.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <span className="text-xs font-black uppercase tracking-widest text-stone-400 group-hover:text-red-600 mb-2 block">
                    Band 0-9
                  </span>
                  <span className="text-3xl font-black font-serif text-stone-900 block mb-1">
                    IELTS
                  </span>
                ...
                >
                  ...
                  <span className="text-xs font-black uppercase tracking-widest text-stone-400 group-hover:text-blue-600 mb-2 block">
                    Score 10-90
                  </span>
                  <span className="text-3xl font-black font-serif text-stone-900 block mb-1">
                    PTE
            ...
            <div className="text-center py-12 space-y-4">
              ...
              <p className="font-serif text-xl text-stone-600 animate-pulse">
                {examType === "ielts"
                  ? "Checking Task Response & Cohesion..."
                  : "Analyzing Content, Form & Grammar..."}
              </p>
            </div>
          ) : error ? (
            ...
            <>
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between border-b-2 border-stone-200 pb-6 gap-6">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`text-[10px] font-black uppercase tracking-widest text-white px-2 py-0.5 ${examType === "ielts" ? "bg-red-600" : "bg-blue-600"}`}
                    >
                  ...
                  <div className="text-6xl font-black font-serif text-stone-900">
                ...
                <div className="flex flex-wrap gap-2 md:gap-4 w-full md:w-auto bg-stone-50 p-4 border border-stone-200 justify-center md:justify-end">
                  {feedback.breakdown &&
                    Object.entries(feedback.breakdown).map(([key, score]) => (
                      <div
                        key={key}
                        className="text-center group relative cursor-help min-w-[60px]"
                      >
                        <div
                          className="text-[10px] font-bold text-stone-400 uppercase tracking-wider mb-1 truncate max-w-[80px] mx-auto"
                          title={key}
                        >
                          {key}
                        </div>
              ...
              <div className="mt-6 space-y-4">
                <div>
                  ...
                  <p className="text-stone-700 leading-relaxed whitespace-pre-line border-l-2 border-stone-900 pl-4">
                    {feedback.critique}
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-sm font-medium text-stone-600 bg-green-50 p-3 border border-green-200">
                      {feedback.strengths}
                    </p>
                  </div>
                  {feedback.weakness && (
                    <div>
                      ...
                      <p className="text-sm font-medium text-stone-600 bg-red-50 p-3 border border-red-200">
                        {feedback.weakness}
                      </p>
                    </div>
                  )}
              ...
              <div className="bg-yellow-50 p-4 border-l-4 border-yellow-400 text-sm text-stone-600 italic mt-4">
                Disclaimer: This is an AI estimation based on public {examType.toUpperCase()}{" "}
                descriptors. Official results may vary.
              </div>

              <button
                onClick={() => setExamType(null)}
                className="text-center w-full text-xs font-bold uppercase tracking-widest text-stone-400 hover:text-stone-900 mt-2"
              >
          ...
          <button
            onClick={onClose}
            className="w-full bg-stone-900 text-white py-4 font-bold uppercase tracking-widest hover:bg-stone-700 transition-colors"
          >
            Close Report
          </button>
        </div>
