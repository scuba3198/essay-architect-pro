    ...
    >
      ...
      <div className="bg-stone-900 p-6 text-white relative overflow-hidden shrink-0 flex justify-between items-center">
        <div>
          ...
          <h2 className="text-3xl font-serif font-black tracking-tight leading-none">
            How to Use
            <br />
            Essay Architect
          </h2>
      ...
      <div className="p-6 overflow-y-auto custom-scrollbar flex-1 space-y-8">
        ...
        <section>
          <p className="font-serif text-lg leading-relaxed text-stone-800 italic border-l-4 border-yellow-400 pl-4 mb-4">
            "Essay Architect is designed to simulate the high-pressure environment of IELTS and PTE
            exams while providing the detailed feedback of a professional tutor."
          </p>
        </section>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="bg-white p-4 border border-stone-200">
              ...
              <p className="text-sm text-stone-600">
                Consider this your textbook. It contains curated lessons on essay structure,
                vocabulary, and what examiners explicitly look for. Read this to understand the
            ...
            <div className="bg-white p-4 border border-stone-200">
              ...
              <p className="text-sm text-stone-600">
                This is your workshop. It breaks the essay writing process into manageable chunks
                (Intro, Body Paragraphs, Conclusion) so you never face a blank page.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="space-y-4">
            <div className="flex gap-3">
              <div className="bg-stone-100 p-2 h-fit rounded">
                <PenTool size={16} />
              </div>
              <div>
                <h4 className="font-bold text-sm uppercase tracking-wide">Step-by-Step Writing</h4>
                <p className="text-sm text-stone-600 mt-1">
                  Don't try to write the whole essay at once. The Wizard guides you to write one
                  specific part at a time (e.g., "Write a clear Thesis Statement"). Focusing on
                  small tasks builds a better whole.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600 mt-1">
                  Writer's block? Press the <strong>"Complete"</strong> button, and our AI will read
                  what you've written so far and suggest a logical continuation. It's like having a
                  co-writer.
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-600 mt-1">
                  Wrote a sentence but it feels simple? Use the <strong>"Refine"</strong> button to
                  instantly upgrade your vocabulary and grammar to an academic standard.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="bg-stone-900 text-stone-300 p-4 text-sm rounded-sm">
            <ul className="list-disc pl-4 space-y-2">
              <li>
                <strong className="text-white">Strict Scoring:</strong> You get a Band 0-9 (IELTS)
                or 10-90 (PTE) score.
              </li>
              <li>
                <strong className="text-white">Detailed Feedback:</strong> The AI explains exactly{" "}
                <em>why</em> you got that score.
              </li>
              <li>
                <strong className="text-white">Actionable Fixes:</strong> It highlights specific
        ...
        <div className="bg-yellow-400/20 border border-yellow-400 p-4 text-sm text-stone-800">
          <strong>Pro Tip:</strong> Use the Timer <Clock className="inline w-3 h-3" /> in the header
          to simulate real exam conditions (40 mins for IELTS Task 2).
        </div>
