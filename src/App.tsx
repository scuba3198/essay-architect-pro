...
import { PenTool, RefreshCw, Clock, RotateCcw, HelpCircle, Award, Zap, Github, Facebook, Menu, X } from 'lucide-react';
...
const App: React.FC = () => {
    ...
    const verifyAccess = async (user: UserType | null, isSilent: boolean = false) => {
        if (!user) {
            setIsPaid(false);
            setActivePlan(null);
            setUserEmail('');
    ...
    const handleTopicChange = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
        ...
        setTopic(prev => prev ? { ...prev, question: newQuestion } : { question: newQuestion, id: 0, type: 'default' } as Topic);
    };
